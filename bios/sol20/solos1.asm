; NOTE: THIS IS A HACKED UP VERSION OF THE "OFFICIAL" V1.3 SOLOS
;       SOURCE CODE.  IT WAS TWEAKED TO MATCH THE EXISTING BINARY
;       FOUND IN A PERSONALITY MODULE OF A PARTICULAR MACHINE.
;
;                                  JIM BATTLE 12/15/99
...
;
LOADKEY	EQU	8CH
	CPI	LOADKEY	; if the user types the LOAD key ...
	JZ	0E900H	; ... then jump to 0xE900
...
DLOP1:	DCX	D
	...
	NOP		; pad out to exactly fill 2KB
;
;
;********* END OF PROGRAM ************
;
